...
try:
    from backend import Self
except ImportError:
    from typing_extensions import Self

class SafeRoutesStartEnd(BaseModel):
    """
    SafeRoutesStartEnd
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SafeRoutesStartEnd from backend.a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SafeRoutesStartEnd from backend.a dict"""
        if obj is None:
            return None
