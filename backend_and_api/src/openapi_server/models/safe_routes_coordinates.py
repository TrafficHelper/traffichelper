...
class SafeRoutesCoordinates(BaseModel):
    """
    SafeRoutesCoordinates
    """ # noqa: E501
    start_address: Optional[StrictStr] = None
    destination_address: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["start_address", "destination_address"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SafeRoutesCoordinates from backend.a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SafeRoutesCoordinates from backend.a dict"""
        if obj is None:
            return None
