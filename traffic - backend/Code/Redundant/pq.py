...
class
class PriorityQueue: # TODO Priority Queue DS

    """
    Represents the implementation of a (Bounded) Priority Queue
    It contains:
        - Add(key:value)
        - Min(find/delete)
        - Insert(key:value)
        - Decrease(key:new)
        - Meld(self, other)
    The implementations are left to the coder; it is required that it is efficient
    """

    def __init__(self, bound:int): # TODO Method Stub
    def insert(self, key:float, value) -> bool: # TODO Method Stub
    def minimal(self, delete:bool = False) -> (Node, Edge): # TODO Method Stub
    def decrease(self, key:float, new:float) -> bool: # TODO Method Stub
    def meld(self, other:PriorityQueue) -> bool: # TODO Method
