...
from Code.Accident.injury import Injury
...
class Outcome(Parser):
    ...
    def __eq__(self, other:Outcome):
        return self.outcome.keys() == other.outcome.keys() and self.outcome.values() == other.outcome.values()
