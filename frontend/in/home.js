...
function redirect_regular_mode() { 
  // console.log("redirect regular mode");
  var regular_form = './form.html';
  window.location.href = regular_form;
}

function redirect_admin_mode() { 
  // console.log("redirect admin mode");
  var admin_form = './admin.html';
  window.location.href = admin_form;
}

var regular_button = document.getElementById("regular-button");
