...
TRAFFIC_NETWORK_FILEPATH = '/Users/matthewzhou/Desktop/traffichelper/xoutput/src/backend/Data/network.graphml'  # Filepath of cached raw GraphML-type traffic network
...
DOMAIN_ACCIDENTS_FILENAME = 'src/backend/Data/accidents_objects.pickle'
